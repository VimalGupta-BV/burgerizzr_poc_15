...
class AsplGiftCard(models.Model):
    ...
    def write_gift_card_from_ui(self, new_card_no):
        ...
        try:
            template_obj = self.env.ref("flexibite_ee_advance.email_template_exchange_number")
...
class AsplGiftCardUse(models.Model):
    ...
    def create(self, vals):
        ...
        if res.pos_order_id:
            try:
                template_obj = self.env.ref('flexibite_ee_advance.email_template_regarding_card_use')
