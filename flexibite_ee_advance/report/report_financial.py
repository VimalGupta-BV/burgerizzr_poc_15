...
class ReportFinancialPdf(models.AbstractModel):
    _name = 'report.flexibite_ee_advance.report_financial'
    ...
    def _compute_report_balance(self, reports):
        """returns a dictionary with key=the ID of a record and value=the credit, debit and balance
        amount computed for this record. If the record is of type :
        ...
        for report in child_reports:
            ...
            if res[report.id].get('account'):
                ...
                for account_id, value in res[report.id]['account'].items():
                    # if there are accounts to display, we add them to the lines with a
                    # level equals to their level in
