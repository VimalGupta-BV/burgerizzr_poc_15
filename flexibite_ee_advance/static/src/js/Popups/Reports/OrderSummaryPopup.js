odoo.define('flexibite_ee_advance.OrderSummaryPopup', function(require) {
    ...
    class OrderSummaryPopup extends AbstractAwaitablePopup {
        ...
        onInputKeyDownNumberValidation(e) {
            if(e.which != 190 && e.which != 110 && e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)
                              && (e.which < 96 || e.which > 105) && (e.which < 37 || e.which > 40)) {
                e.preventDefault();
            }
        }
        getPayload() {
        ...
        async confirm() {
            if(this.state.OrderNumberReceipt <= 0){
                 $('#no_of_copies').css('border','1px solid #72739f');
                 return;
            }
