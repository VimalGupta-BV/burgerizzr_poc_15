...
class AccountFinancialReport(models.Model):
    ...
    account_type_ids = fields.Many2many('account.account.type',
                                        'account_account_financial_report_type', 'report_id',
    ...
    sign = fields.Selection([('-1', 'Reverse balance sign'), ('1', 'Preserve balance sign')],
                            ...
                            help='For accounts that are typically more debited than '
                                 ...
                                 ' amounts in your reports, you should reverse the sign '
                                 'of the balance; e.g.: Expense account. '
                                 'The same applies for accounts that are typically more '
                                 'credited than debited and that you would like to print '
                                 'as positive amounts in your reports; e.g.: Income account.')
